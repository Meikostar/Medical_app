...
public class AlarmPopWindow extends PopupWindow{
    ...
    public AlarmPopWindow(Activity context){
        super(context);
        mContext = context;
        mView = LayoutInflater.from(mContext).inflate(R.layout.alarm_pop, null);
    ...
    public void setCont(String text){
...
//        this.setOutsideTouchable(false);
    ...
    public AlarmPopWindow bindView(View view) {
        mView = view;
        return this;
    }
}
