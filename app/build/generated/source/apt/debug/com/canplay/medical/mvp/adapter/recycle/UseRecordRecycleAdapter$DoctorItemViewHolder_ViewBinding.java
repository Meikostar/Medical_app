...
public class UseRecordRecycleAdapter$DoctorItemViewHolder_ViewBinding implements Unbinder {
  private UseRecordRecycleAdapter.DoctorItemViewHolder target;

  @UiThread
  public UseRecordRecycleAdapter$DoctorItemViewHolder_ViewBinding(UseRecordRecycleAdapter.DoctorItemViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UseRecordRecycleAdapter.DoctorItemViewHolder target = this.target;
