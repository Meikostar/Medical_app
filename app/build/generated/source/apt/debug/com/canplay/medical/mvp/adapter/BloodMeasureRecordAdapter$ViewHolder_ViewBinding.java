...
public class BloodMeasureRecordAdapter$ViewHolder_ViewBinding implements Unbinder {
  private BloodMeasureRecordAdapter.ViewHolder target;

  @UiThread
  public BloodMeasureRecordAdapter$ViewHolder_ViewBinding(BloodMeasureRecordAdapter.ViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    BloodMeasureRecordAdapter.ViewHolder target = this.target;
