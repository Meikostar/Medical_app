...
public class SugarChartRecordActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public SugarChartRecordActivity_ViewBinding(SugarChartRecordActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SugarChartRecordActivity_ViewBinding(SugarChartRecordActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SugarChartRecordActivity target = this.target;
